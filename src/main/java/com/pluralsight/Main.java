...
public class Main {
    public static void main(String[] args) {
        ...
        assets.add(new House ("11/08/2023", "Vacation Beach House", 500000, "1809 Self way", 1, 6000, 10000));
        assets.add(new Vehicle ("05/15/2023", "Angels car ", 15000, "Volkswagon Jetta", 2023, 28120));
